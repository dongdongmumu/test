...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'height:18rpx;width:100%;background-color:#f5f5f5;'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'d-flex'])
Z([3,'color:#FD6801;font-size:24rpx;'])
Z([3,'￥'])
...
var tEB=_mz(z,'view',['bindtap',6,'class',1,'data-event-opts',2],[],oBB,cAB,gg)
var eFB=_mz(z,'image',['mode',9,'src',1,'style',2],[],oBB,cAB,gg)
_(tEB,eFB)
var bGB=_n('text')
var oHB=_oz(z,12,oBB,cAB,gg)
_(bGB,oHB)
_(tEB,bGB)
_(lCB,tEB)
return lCB
...
var z=gz$gwx_6()
var oJB=_n('view')
var fKB=_mz(z,'swiper',['autoplay',-1,'circular',-1,'indicatorDots',-1,'class',0,'duration',1,'interval',1],[],e,s,gg)
var cLB=_v()
_(fKB,cLB)
var hMB=function(cOB,oNB,oPB,gg){
var aRB=_n('swiper-item')
var tSB=_mz(z,'view',['bindtap',7,'class',1,'data-event-opts',2],[],cOB,oNB,gg)
var eTB=_mz(z,'image',['lazyLoad',-1,'src',10,'style',1],[],cOB,oNB,gg)
_(tSB,eTB)
_(aRB,tSB)
_(oPB,aRB)
return oPB
...
cLB.wxXCkey=2
_2z(z,5,hMB,e,s,gg,cLB,'item','index','index')
_(oJB,fKB)
_(r,oJB)
return r
}
...
var z=gz$gwx_7()
var oVB=_n('view')
var xWB=_mz(z,'heavy-line',['bind:__l',0,'vueId',1],[],e,s,gg)
_(oVB,xWB)
var oXB=_mz(z,'view',['class',2,'style',1],[],e,s,gg)
var fYB=_mz(z,'view',['bindtap',4,'data-event-opts',1],[],e,s,gg)
var cZB=_mz(z,'image',['lazyLoad',-1,'mode',-1,'src',6,'style',1],[],e,s,gg)
_(fYB,cZB)
_(oXB,fYB)
var h1B=_mz(z,'view',['class',8,'style',1],[],e,s,gg)
var o2B=_mz(z,'image',['lazyLoad',-1,'mode',-1,'bindtap',10,'data-event-opts',1,'src',2,'style',3],[],e,s,gg)
_(h1B,o2B)
var c3B=_mz(z,'image',['lazyLoad',-1,'mode',-1,'bindtap',14,'data-event-opts',1,'src',2,'style',3],[],e,s,gg)
_(h1B,c3B)
_(oXB,h1B)
_(oVB,oXB)
var o4B=_mz(z,'heavy-line',['bind:__l',18,'vueId',1],[],e,s,gg)
_(oVB,o4B)
_(r,oVB)
return r
}
...
var hEC=_mz(z,'scroll-view',['scrollX',-1,'class',1,'id',1,'scrollLeft',2],[],e,s,gg)
var oFC=_v()
_(hEC,oFC)
var cGC=function(lIC,oHC,aJC,gg){
var eLC=_mz(z,'view',['bindtap',8,'class',1,'data-current',2,'data-event-opts',3,'id',4],[],lIC,oHC,gg)
var bMC=_n('view')
_rz(z,bMC,'class',13,lIC,oHC,gg)
var oNC=_oz(z,14,lIC,oHC,gg)
_(bMC,oNC)
_(eLC,bMC)
_(aJC,eLC)
return aJC
...
oFC.wxXCkey=2
_2z(z,6,cGC,e,s,gg,oFC,'tab','index','id')
_(cDC,hEC)
var xOC=_mz(z,'swiper',['bindchange',15,'class',1,'current',2,'data-event-opts',3,'duration',4],[],e,s,gg)
var oPC=_v()
_(xOC,oPC)
var fQC=function(hSC,cRC,oTC,gg){
var oVC=_n('swiper-item')
var lWC=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',24,'class',1,'data-event-opts',2],[],hSC,cRC,gg)
var aXC=_v()
_(lWC,aXC)
if(_oz(z,27,hSC,cRC,gg)){aXC.wxVkey=1
var eZC=_v()
_(aXC,eZC)
var b1C=function(x3C,o2C,o4C,gg){
var c6C=_v()
_(o4C,c6C)
if(_oz(z,32,x3C,o2C,gg)){c6C.wxVkey=1
var h7C=_mz(z,'swiper-image',['bind:__l',33,'resdata',1,'vueId',2],[],x3C,o2C,gg)
_(c6C,h7C)
}
else{c6C.wxVkey=2
var o8C=_v()
_(c6C,o8C)
if(_oz(z,36,x3C,o2C,gg)){o8C.wxVkey=1
var c9C=_mz(z,'index-nav',['bind:__l',37,'resdata',1,'vueId',2],[],x3C,o2C,gg)
_(o8C,c9C)
var o0C=_mz(z,'divider',['bind:__l',40,'vueId',1],[],x3C,o2C,gg)
_(o8C,o0C)
}
else{o8C.wxVkey=2
var lAD=_v()
_(o8C,lAD)
if(_oz(z,42,x3C,o2C,gg)){lAD.wxVkey=1
var aBD=_mz(z,'three-adv',['bind:__l',43,'resdata',1,'vueId',2],[],x3C,o2C,gg)
_(lAD,aBD)
var tCD=_mz(z,'divider',['bind:__l',46,'vueId',1],[],x3C,o2C,gg)
_(lAD,tCD)
}
else{lAD.wxVkey=2
var eDD=_v()
_(lAD,eDD)
if(_oz(z,48,x3C,o2C,gg)){eDD.wxVkey=1
var bED=_mz(z,'card',['bind:__l',49,'bodyCover',1,'headTitle',2,'vueId',3],[],x3C,o2C,gg)
_(eDD,bED)
}
else{eDD.wxVkey=2
var oFD=_v()
_(eDD,oFD)
if(_oz(z,53,x3C,o2C,gg)){oFD.wxVkey=1
var xGD=_n('view')
_rz(z,xGD,'class',54,x3C,o2C,gg)
var oHD=_v()
_(xGD,oHD)
var fID=function(hKD,cJD,oLD,gg){
var oND=_mz(z,'common-list',['bind:__l',59,'index',1,'item',2,'vueId',3],[],hKD,cJD,gg)
_(oLD,oND)
return oLD
}
oHD.wxXCkey=4
_2z(z,57,fID,x3C,o2C,gg,oHD,'vlist','listindex','listindex')
_(oFD,xGD)
}
oFD.wxXCkey=1
oFD.wxXCkey=3
...
eZC.wxXCkey=4
_2z(z,30,b1C,hSC,cRC,gg,eZC,'v','i','i')
}
var tYC=_v()
_(lWC,tYC)
if(_oz(z,63,hSC,cRC,gg)){tYC.wxVkey=1
var lOD=_v()
_(tYC,lOD)
var aPD=function(eRD,tQD,bSD,gg){
var xUD=_v()
_(bSD,xUD)
if(_oz(z,68,eRD,tQD,gg)){xUD.wxVkey=1
var oVD=_mz(z,'swiper-image',['bind:__l',69,'resdata',1,'vueId',2],[],eRD,tQD,gg)
_(xUD,oVD)
}
else{xUD.wxVkey=2
var fWD=_v()
_(xUD,fWD)
if(_oz(z,72,eRD,tQD,gg)){fWD.wxVkey=1
var cXD=_mz(z,'index-nav',['bind:__l',73,'resdata',1,'vueId',2],[],eRD,tQD,gg)
_(fWD,cXD)
var hYD=_mz(z,'divider',['bind:__l',76,'vueId',1],[],eRD,tQD,gg)
_(fWD,hYD)
}
else{fWD.wxVkey=2
var oZD=_v()
_(fWD,oZD)
if(_oz(z,78,eRD,tQD,gg)){oZD.wxVkey=1
var c1D=_mz(z,'card',['bind:__l',79,'headTitle',1,'vueId',2,'vueSlots',3],[],eRD,tQD,gg)
var o2D=_n('view')
_rz(z,o2D,'class',83,eRD,tQD,gg)
var l3D=_v()
_(o2D,l3D)
var a4D=function(e6D,t5D,b7D,gg){
var x9D=_mz(z,'common-list',['bind:__l',88,'index',1,'item',2,'vueId',3],[],e6D,t5D,gg)
_(b7D,x9D)
return b7D
}
l3D.wxXCkey=4
_2z(z,86,a4D,eRD,tQD,gg,l3D,'vlist','listindex','listindex')
_(c1D,o2D)
_(oZD,c1D)
}
oZD.wxXCkey=1
...
lOD.wxXCkey=4
_2z(z,66,aPD,hSC,cRC,gg,lOD,'v','i','i')
}
var o0D=_n('view')
_rz(z,o0D,'class',92,hSC,cRC,gg)
var fAE=_oz(z,93,hSC,cRC,gg)
_(o0D,fAE)
_(lWC,o0D)
aXC.wxXCkey=1
aXC.wxXCkey=3
...
oPC.wxXCkey=4
_2z(z,22,fQC,e,s,gg,oPC,'tab','index1','index1')
_(cDC,xOC)
_(r,cDC)
return r
}
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:1773:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:1773:1)",{path:"./app.wxss"});    
...
__wxAppCode__['components/common/heavyLine.wxss']=undefined;    
__wxAppCode__['components/common/heavyLine.wxml']=$gwx('./components/common/heavyLine.wxml');
